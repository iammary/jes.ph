export const ContentContainer: React.FC<{
  ...
  <div
    ...
    data-theme={mode}>
    <div
      className={`z-10 w-full lg:w-3/4 xl:w-1/2 rounded-(--border-radius) p-10 flex flex-col gap-(--spacing-sm) max-h-[calc(100vh-calc(var(--spacing-base)*6))] overflow-y-auto ${
