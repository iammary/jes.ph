  ...
  return (
    <ContentContainer>
      ...
      <div className="flex flex-col gap-4">
        ...
        <p>
          I care deeply about the foundations: design systems, shared UI platforms, micro-frontend patterns, and and the JavaScript that ties everything
          together. I enjoy working at the intersection of engineering and design, shaping frontend systems that are intuitive for users and pleasant for
        ...
        <p>
          Whether I’m thinking about architecture, performance, testing, or developer workflows, my goal is always the same — to build systems that age well.
        </p>
      </div>
    </ContentContainer>
  );
